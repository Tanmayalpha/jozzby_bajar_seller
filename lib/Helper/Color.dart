...
const Color primary = Color(0xffEA4F1C);
const Color secondary = Color(0xffF18A22);
const Color newPrimary = Color(0xffff6a63);
const Color fontColor = Color(0xff4543C1);
const Color grad1Color = Color(0xffEA4F1C);
const Color grad2Color = Color(0xffF18A22);
...
const Color grey2 = Color(0xffe6e6e6);
const Color grey3 = Color(0xff989898);
...
const Color blarColor = Color(0x29000000);
const Color fillColor = Color(0xfff6d6d5);
const Color shadowColor = Color(0x17000000);
