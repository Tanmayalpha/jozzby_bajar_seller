...
class ProfileProvider extends ChangeNotifier {
  ...
  Future<void> getSallerDetail(BuildContext context,
  ...
  Future<void> setUpdateUser(BuildContext context,
      Function update,) async {
    var parameter = {
      Id: context
          .read<SettingProvider>()
  ...
  Future<void> updateProfilePic(BuildContext context,
      Function update,) async {
    isNetworkAvail = await isNetworkAvailable();
    if (isNetworkAvail) {
      try {
