                                        ...
                                        child: Padding(
                                          ...
                                          child: InkWell(
                                            child: Container(
                                              ...
                                              child: Text( 'Create Pickup to your location'
                                                /*getTranslated(
                                                  context,
...
//============================ Status of Order =================================
  ...
  Future<void> createPickupRequest() async {

    String? address = await getPrefrence(Address);
    String? sellerName = await getPrefrence(Username);
    String? mobile = await getPrefrence(Mobile);
    String? pinCode = await getPrefrence(Pincode);
    String? lat = await getPrefrence(Latitude);
    String? lng = await getPrefrence(Longitude);




    var headers = {
      'Cookie': 'AWSALB=31aznIMIVw7guXzInNR5RHNR2gtyTfoXP1jWHuoN1LUq8Gr7VNY1oob5e8WWzwoWVgbFDjRnVDQqNy1wD/hjfuDlezdW3KtDLuAlz21Vin98YXTd5/35uv3foEMi; AWSALBCORS=31aznIMIVw7guXzInNR5RHNR2gtyTfoXP1jWHuoN1LUq8Gr7VNY1oob5e8WWzwoWVgbFDjRnVDQqNy1wD/hjfuDlezdW3KtDLuAlz21Vin98YXTd5/35uv3foEMi'
    };
    var request = http.MultipartRequest('POST', Uri.parse('https://api.ecomexpress.in/apiv2/manifest_awb/'));
    request.fields.addAll({
      'username': 'JOSSBYTECHNOLOGIESINDIAPVTLTD-EGS514326',
      'password': '5hGBxrCzly',
      'json_input': '[{\n\t"AWB_NUMBER": "3019289210",'
          ...
          '\n\t"BREADTH": 5,'
          '\n\t"HEIGHT": 2,'
          '\n\t"PICKUP_NAME": "${sellerName}",'
          '\n\t"PICKUP_ADDRESS_LINE1": "${address}",'
