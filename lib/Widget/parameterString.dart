...
const String ExtraInputDesc = 'extra_input_description';
...
const String AuthSign = "authorized_signature";
...
const String BREADTH = 'breadth';
const String LENGTH = 'length';
const String PICKUP_LOCATION = 'pickup_location';
const String PHONE = 'phone';
const String STATE = 'state';
const String COUNTRY = 'country';
const String PIN_CODE = 'pin_code';
const String IS_SHIPROCKET_ORDER = 'is_shiprocket_order';
const String PARCEL_WEIGHT = 'parcel_weight';
...
const String SHIPROCKET_ORDER_ID = 'shiprocket_order_id';
...
const String IS_CANCELED = 'is_canceled';
const String LABEL_URL = 'label_url';
const String INVOICE_URL = 'invoice_url';
const String PICKUP_SCHEDULED_DATE = 'pickup_scheduled_date';
